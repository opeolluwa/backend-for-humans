...
manipulated folders and files creation with it amongst other things. This module
will build on the previous knowledge from that module.
...
4. read a shell file and explain what it is meant for.
